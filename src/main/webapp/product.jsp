    ...
    <div class="container">
      <div class="banner_content d-md-flex justify-content-between align-items-center">
        ...
        <div class="page_link">
          ...
          <a href="product.jsp">Women Fashion</a>
        </div>
      </div>
    </div>
  </div>
        ...
        <div class="left_sidebar_area">
          <aside class="left_widgets p_filter_widgets">
            ...
            <div class="widgets_inner">
              <ul class="list">
                <c:forEach items="${listCG}" var="o">
                <li class="${tag == o.idcategory ? "active":""}">
                  <a href="/category?cid=${o.idcategory}" >${o.namecategory}</a>
                </li>
                </c:forEach>
              </ul>
            </div>
