        ...
        <div class="container">
            ...
            >
                <div class="mb-3 mb-md-0">
                    <h2>Edit Product</h2>
                    <c:if test="${sessionScope.acc != null }">
                        <h3>Welcomback Admin ${sessionScope.acc.name}</h3>
                    </c:if>
                </div>
                <div class="page_link">
                    <a href="">Home</a>
                    ...
                    <div align="center">
                        <form action="/edit" method="post">
                            ...
                            <table>
                                <tr>
                                    <td>Enter ID</td>
                                    <td><input name="id" value="${sanpham.id}" readonly></td>
                                </tr>
                                <tr>
                                    <td>Enter name</td>
                                    <td><input name="name" value="${sanpham.name}"></td>
                                </tr>
                                <tr>
                                    <td>Enter img</td>
                                ...
                                <tr>
                                    ...
                                    <td><input name="amount" value="${sanpham.amount}"></td>
                                </tr>
<%--                                <tr>--%>
...
<%--                                </tr>--%>
                                <tr>
                                    ...
                                    <td><input name="describe" value="${sanpham.describe}"></td>
                                </tr>
                                <tr>
                                    <td>Enter amount total</td>
