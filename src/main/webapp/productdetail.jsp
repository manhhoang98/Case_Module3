        ...
        <div class="container">
          ...
          >
            ...
            <div class="page_link">
              ...
              <a href="productdetail.jsp">Product Details</a>
            </div>
          </div>
        </div>
      </div>
            ...
            <div class="s_product_img">
              ...
              >
                <ol class="carousel-indicators">
                  ...
                  >
                    <img
                      src="${p.img}" height="60px" width="60px"
                      alt=""
                    />
                  </li>
                  <li
                ...
                <div class="comment_list">
                  <div class="review_item">
                    <div class="media">
                      <div class="d-flex">
                        <img
                          src="web/img/product/single-product/review-1.png"
                          alt=""
                        />
                      </div>
                  ...
                  <div class="review_item reply">
                    <div class="media">
                      <div class="d-flex">
                        <img
                          src="web/img/product/single-product/review-2.png"
                          alt=""
                        />
                      </div>
                      <div class="media-body">
                  ...
                  <div class="review_item">
                    <div class="media">
                      <div class="d-flex">
                        <img
                          src="web/img/product/single-product/review-3.png"
                          alt=""
                        />
                      </div>
                      <div class="media-body">
              ...
              <div class="col-lg-6">
                <div class="review_box">
                  ...
                  <form
                    ...
                    action="web/contact_process.php"
                    method="post"
                    id="contactForm"
