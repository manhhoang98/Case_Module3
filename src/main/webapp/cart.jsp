        ...
        <div class="container">
          ...
          >
            <div class="mb-3 mb-md-0">
              <h2>Cart</h2>
              <c:if test="${sessionScope.acc != null }">
                <p>Giỏ hàng của ${sessionScope.acc.name}</p>
              </c:if>
            </div>
            <div class="page_link">
            ...
            <table class="table">
              ...
              <c:forEach items="${cart}" var="product">
                <tr>
                  ...
                  <td>${product.price}</td>
                  <td>                <a style="position: relative" type="button" class="btn btn-danger" href="/cart?id=${product.id}&action=delete">Delete</a>
                  </td>
                ...
                <tr class="out_button_area">
                  ...
                  <td>
                    <div class="checkout_btn_inner">
                      <a class="main_btn" href="#">Đến trang thanh toán</a>
                    </div>
                  </td>
                </tr>
              </tbody>
