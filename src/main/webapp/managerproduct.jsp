    ...
    <div class="container">
      ...
      >
        <div class="mb-3 mb-md-0">
          ...
          <c:if test="${sessionScope.acc != null }">
            <h4 >Welcomback Admin ${sessionScope.acc.name}</h4>
          </c:if>
        </div>
        <div class="page_link">
          <a href="">Home</a>
        ...
        <table class="table">
          ...
          <c:forEach items="${sanphams}" var="product">
            <tr>
              ...
              <td>
                <a style="position: relative" type="button" class="btn btn-warning" href="/edit?id=${product.id}">Edit</a>
                <a style="position: relative" type="button" class="btn btn-danger" href="/delete?id=${product.id}">Delete</a>
              </td>
            </tr>
          </c:forEach>
